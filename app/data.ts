...
export const architectures: ArchitectureDefinition[] = [
  {
    ...
    nodes: [
      { id: 'web_client', kind: 'client', name: 'Web client', shortName: 'WEB', region: 'europe-west2', replicas: 1, capacityPerReplica: 30000, legalRemediations: [], x: 14, y: 44, accent: 'cyan' },
      { id: 'api_gateway', kind: 'gateway', name: 'API Gateway', shortName: 'API', region: 'europe-west2', replicas: 2, replicaZones: ['europe-west2-a', 'europe-west2-b'], capacityPerReplica: 8000, legalRemediations: ['set_autoscaling'], x: 32, y: 44, accent: 'cyan' },
      { id: 'cloud_run_order', kind: 'service', name: 'Cloud Run / Order', shortName: 'RUN / ORDER', region: 'europe-west2', replicas: 2, replicaZones: ['europe-west2-a', 'europe-west2-b'], capacityPerReplica: 6500, legalRemediations: ['set_autoscaling'], x: 50, y: 44, accent: 'orange' },
      { id: 'pubsub_ordered', kind: 'queue', name: 'Pub/Sub ordered subscription', shortName: 'PUB/SUB', region: 'europe-west2', replicas: 1, capacityPerReplica: 300, legalRemediations: ['set_ordering_key_parallelism', 'set_batching'], x: 68, y: 44, accent: 'orange' },
      { id: 'cloud_run_payment', kind: 'service', name: 'Cloud Run / Payment', shortName: 'RUN / PAY', region: 'europe-west2', replicas: 2, replicaZones: ['europe-west2-a', 'europe-west2-b'], capacityPerReplica: 6000, legalRemediations: ['set_autoscaling'], x: 86, y: 44, accent: 'acid' },
      { id: 'cloud_sql', kind: 'db', name: 'Cloud SQL for PostgreSQL', shortName: 'CLOUD SQL', region: 'europe-west2', replicas: 1, replicaZones: ['europe-west2-a'], capacityPerReplica: 12000, legalRemediations: ['add_read_replica', 'restore_component'], x: 50, y: 74, accent: 'violet' },
      { id: 'memorystore', kind: 'cache', name: 'Memorystore for Redis', shortName: 'MEMORYSTORE', region: 'europe-west2', replicas: 1, capacityPerReplica: 18000, legalRemediations: ['set_autoscaling'], x: 86, y: 74, accent: 'cyan' },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'app_us', kind: 'service', name: 'Cloud Run app / us-east4', shortName: 'APP / US', region: 'us-east4', replicas: 2, replicaZones: ['us-east4-a', 'us-east4-b'], capacityPerReplica: 1900, legalRemediations: ['set_autoscaling'], x: 51, y: 75, accent: 'acid' },
      { id: 'cloud_sql_primary', kind: 'db', name: 'Cloud SQL primary', shortName: 'SQL / EU', region: 'europe-west2', replicas: 1, replicaZones: ['europe-west2-a'], capacityPerReplica: 12000, legalRemediations: ['restore_component'], x: 69, y: 33, accent: 'violet' },
      { id: 'cloud_sql_replica', kind: 'db', name: 'Cloud SQL cross-region replica', shortName: 'SQL / US', region: 'us-east4', replicas: 1, replicaZones: ['us-east4-a'], capacityPerReplica: 12000, legalRemediations: ['restore_component'], x: 69, y: 75, accent: 'violet' },
      { id: 'memorystore', kind: 'cache', name: 'Memorystore for Redis', shortName: 'MEMORYSTORE', region: 'europe-west2', replicas: 2, replicaZones: ['europe-west2-a', 'europe-west2-b'], capacityPerReplica: 12000, legalRemediations: [], x: 87, y: 33, accent: 'orange' },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'pubsub_overflow', kind: 'queue', name: 'Pub/Sub overflow subscription', shortName: 'PUB/SUB', region: 'europe-west2', replicas: 1, capacityPerReplica: 1000, legalRemediations: ['set_batching'], x: 86, y: 77, accent: 'orange' },
    ],
    edges: [
