...
export const architectures: ArchitectureDefinition[] = [
  {
    ...
    nodes: [
      ...
      { id: 'api_gateway', kind: 'gateway', name: 'API Gateway', shortName: 'API', region: 'europe-west2', replicas: 2, replicaZones: ['europe-west2-a', 'europe-west2-b'], capacityPerReplica: 8000, legalRemediations: ['set_autoscaling'], x: 28, y: 45, accent: 'cyan' },
      { id: 'cloud_run_order', kind: 'service', name: 'Cloud Run / Order', shortName: 'RUN / ORDER', region: 'europe-west2', replicas: 2, replicaZones: ['europe-west2-a', 'europe-west2-b'], capacityPerReplica: 6500, legalRemediations: ['set_autoscaling'], x: 44, y: 45, accent: 'orange' },
      { id: 'pubsub_ordered', kind: 'queue', name: 'Pub/Sub ordered subscription', shortName: 'PUB/SUB', region: 'europe-west2', replicas: 1, capacityPerReplica: 300, legalRemediations: ['set_ordering_key_parallelism', 'set_batching'], x: 62, y: 45, accent: 'orange' },
      { id: 'cloud_run_payment', kind: 'service', name: 'Cloud Run / Payment', shortName: 'RUN / PAY', region: 'europe-west2', replicas: 2, replicaZones: ['europe-west2-a', 'europe-west2-b'], capacityPerReplica: 6000, legalRemediations: ['set_autoscaling'], x: 82, y: 45, accent: 'acid' },
      { id: 'cloud_sql', kind: 'db', name: 'Cloud SQL for PostgreSQL', shortName: 'CLOUD SQL', region: 'europe-west2', replicas: 1, replicaZones: ['europe-west2-a'], capacityPerReplica: 12000, legalRemediations: ['add_read_replica', 'restore_component'], x: 44, y: 76, accent: 'violet' },
      { id: 'memorystore', kind: 'cache', name: 'Memorystore for Redis', shortName: 'MEMORYSTORE', region: 'europe-west2', replicas: 1, capacityPerReplica: 18000, legalRemediations: ['set_autoscaling'], x: 62, y: 76, accent: 'cyan' },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'cloud_run_europe', kind: 'gateway', name: 'Cloud Run ingress / europe-west2', shortName: 'RUN / EU', region: 'europe-west2', replicas: 2, replicaZones: ['europe-west2-a', 'europe-west2-b'], capacityPerReplica: 2100, legalRemediations: ['set_autoscaling'], x: 31, y: 30, accent: 'cyan' },
      { id: 'cloud_run_us', kind: 'gateway', name: 'Cloud Run ingress / us-east4', shortName: 'RUN / US', region: 'us-east4', replicas: 2, replicaZones: ['us-east4-a', 'us-east4-b'], capacityPerReplica: 2100, legalRemediations: ['set_autoscaling'], x: 31, y: 64, accent: 'cyan' },
      { id: 'app_europe', kind: 'service', name: 'Cloud Run app / europe-west2', shortName: 'APP / EU', region: 'europe-west2', replicas: 2, replicaZones: ['europe-west2-a', 'europe-west2-b'], capacityPerReplica: 1900, legalRemediations: ['set_autoscaling'], x: 52, y: 30, accent: 'acid' },
      { id: 'app_us', kind: 'service', name: 'Cloud Run app / us-east4', shortName: 'APP / US', region: 'us-east4', replicas: 2, replicaZones: ['us-east4-a', 'us-east4-b'], capacityPerReplica: 1900, legalRemediations: ['set_autoscaling'], x: 52, y: 64, accent: 'acid' },
      { id: 'cloud_sql_primary', kind: 'db', name: 'Cloud SQL primary', shortName: 'SQL / EU', region: 'europe-west2', replicas: 1, replicaZones: ['europe-west2-a'], capacityPerReplica: 12000, legalRemediations: ['restore_component'], x: 74, y: 30, accent: 'violet' },
      { id: 'cloud_sql_replica', kind: 'db', name: 'Cloud SQL cross-region replica', shortName: 'SQL / US', region: 'us-east4', replicas: 1, replicaZones: ['us-east4-a'], capacityPerReplica: 12000, legalRemediations: ['restore_component'], x: 74, y: 64, accent: 'violet' },
      { id: 'memorystore', kind: 'cache', name: 'Memorystore for Redis', shortName: 'MEMORYSTORE', region: 'europe-west2', replicas: 2, replicaZones: ['europe-west2-a', 'europe-west2-b'], capacityPerReplica: 12000, legalRemediations: [], x: 86, y: 47, accent: 'orange' },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'api_gateway', kind: 'gateway', name: 'API Gateway', shortName: 'API', region: 'europe-west2', replicas: 2, replicaZones: ['europe-west2-a', 'europe-west2-b'], capacityPerReplica: 220, legalRemediations: ['set_autoscaling'], x: 29, y: 45, accent: 'cyan' },
      { id: 'cloud_run_router', kind: 'service', name: 'Cloud Run / Model router', shortName: 'RUN / ROUTER', region: 'europe-west2', replicas: 2, replicaZones: ['europe-west2-a', 'europe-west2-b'], capacityPerReplica: 220, legalRemediations: ['set_autoscaling'], x: 45, y: 45, accent: 'orange' },
      { id: 'vertex_stable', kind: 'gpu', name: 'Vertex AI endpoint / stable', shortName: 'VERTEX / STABLE', region: 'europe-west2', replicas: 2, replicaZones: ['europe-west2-a', 'europe-west2-b'], capacityPerReplica: 120, capacityModel: { concurrency: 6, serviceTimeMs: 45, schedulingEfficiency: 0.9, reservePercent: 10 }, legalRemediations: ['set_autoscaling', 'set_batching'], x: 64, y: 28, accent: 'cyan' },
      { id: 'vertex_rc', kind: 'gpu', name: 'Vertex AI endpoint / release candidate', shortName: 'VERTEX / RC', region: 'europe-west2', replicas: 3, replicaZones: ['europe-west2-a', 'europe-west2-b', 'europe-west2-a'], capacityPerReplica: 80, capacityModel: { concurrency: 4, serviceTimeMs: 45, schedulingEfficiency: 0.9, reservePercent: 10 }, legalRemediations: ['set_autoscaling', 'set_batching', 'set_model_traffic_split'], x: 64, y: 63, accent: 'acid' },
      { id: 'memorystore', kind: 'cache', name: 'Memorystore for Redis / KV cache', shortName: 'MEMORYSTORE', region: 'europe-west2', replicas: 2, replicaZones: ['europe-west2-a', 'europe-west2-b'], capacityPerReplica: 350, legalRemediations: ['set_autoscaling'], x: 84, y: 28, accent: 'violet' },
